# network_automation/cisco/novenoadmredes/practica3/pnetlab/configDisp/sw1.py

from netmiko import ConnectHandler

from network_automation.cisco.novenoadmredes.practica3.pnetlab.devices import SW1, SYSLOG_SERVER_IP
...
def configurar(conn):
    ...
    conn.send_config_set([
        "interface vlan 1",
        " ip address 192.168.241.101 255.255.255.0",
        " no shutdown",
        "ip default-gateway 192.168.241.100",
    ])
...
def main():
    print("Configurando SW1 (192.168.241.101)...")
    try:
